...
export type InitialStateType = typeof initialStateSettingsCounterReducer

export const initialStateSettingsCounterReducer = {
    startValue: 0,
    maxValue: 1,
    isSettings: false,
    inCorrectValue: true
...
export const settingsCounterReducer = (state = initialStateSettingsCounterReducer, action: ActionType): InitialStateType => {
    switch (action.type) {
